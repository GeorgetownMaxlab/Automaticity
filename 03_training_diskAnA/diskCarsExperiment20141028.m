...
function trialOutput = diskCarsExperiment20141028(name,exptdesign)
...
% %             centPerformance(2) = trialOutput(sessionNum-1).centPerformance;
% %             centPerformance(3) = trialOutput(sessionNum-2).centPerformance;
% %             %check perif performance on last 3 blocks
% %             perifPerformance(1) = trialOutput(sessionNum).perifPerformance;
% %             perifPerformance(2) = trialOutput(sessionNum-1).perifPerformance;
% %             perifPerformance(3) = trialOutput(sessionNum-2).perifPerformance;
% %             %remove zeros
% %             centPerformance=centPerformance(centPerformance>0);
% %             perifPerformance=perifPerformance(perifPerformance>0);
% %             
% %             if max(centPerformance)>0.85
% %                 exptdesign.centSOADurations = max(exptdesign.centSOADurations - exptdesign.refresh*2, exptdesign.refresh);
% %             end
% %             
% %             if max(perifPerformance)>0.85
% %                 exptdesign.perifSOADurations = max(exptdesign.perifSOADurations - exptdesign.refresh*2, exptdesign.refresh);
% %             end
% %             
% %             if min(centPerformance)<0.7
% %                 exptdesign.centSOADurations = exptdesign.centSOADurations + exptdesign.refresh*1;
% %             end
% %             
% %             if min(perifPerformance)<0.7
% %                 exptdesign.perifSOADurations = exptdesign.perifSOADurations + exptdesign.refresh*1;
% %             end
% %             
% %         end
