...
exptdesign.exptname='diskCarsResponseSwitch4';
...
exptdesign.numTrialsPerSession = 72;     % number of trials per session (each session is roughly 1.5 minutes)
...
[trialoutput] = diskCarsExperimentResponseSwitch4(name,exptdesign);